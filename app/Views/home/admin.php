...
<div class="card" style="overflow:hidden">
    <div style="padding:16px 20px;border-bottom:1px solid #f0f0f0;display:flex;justify-content:space-between;align-items:center">
        <h3 style="font-size:15px;font-weight:600;color:#333">Recent Tickets</h3>
        <a href="/tickets" style="font-size:13px;color:#ff891c;text-decoration:none">View all →</a>
    </div>
    <?php if (empty($recentTickets)): ?>
        <p style="padding:20px;color:#bbb;font-size:14px">No tickets yet.</p>
    <?php else: ?>
    <div class="table_section">
        <table>
            ...
            <tr>
                ...
                <td style="font-size:13px;color:#666"><?= htmlspecialchars($ticket['user_name']) ?></td>
